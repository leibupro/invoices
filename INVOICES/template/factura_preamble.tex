...
%
%
%   Purpose:       This file contains the preamble of
%                  the invoice document.
%                  All the sender information etc.,
...
\setkomavar{fromname}{Der Esel}
\setkomavar{fromaddress}{am Berg 7\\
                         CH-3982 Bitsch
                        }
\setkomavar{fromemail}{edonkey2k@mindless.ch}
\setkomavar{backaddressseparator}{ - }

\setkomavar{place}{\flushleft\vspace{-\baselineskip}\hspace{90mm}Bitsch}
...
\setkomavar{frombank}{\textbf{Postchekkonto: 00--00000--0}\linebreak
                      Tightwad Bank\linebreak
                      3982 Bitsch\linebreak
                      \textbf{IBAN-Nr.: CH00\,0000\,0000\,0000\,0000\,0}
                     }
